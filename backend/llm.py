...
class Llm(Enum):
    ...
    DEEPSEEK_R1 = "deepseek-reasonert"
    Qwen2_5_72B_Instruct = "qwen2.5-vl-72b-instruct"
    INTERN_VL2_8B_MPO = "InternVL2-8B-MPO"
    HZB_QWEN_72B = "qwen-72b"
    DEEPSEEK_QWEN = "deepseek-qwen"

# 定义完成响应的类型
class Completion(TypedDict):
    duration: float  # 处理持续时间
    code: str       # 生成的代码
...
async def stream_openai_response(
    ...
    print("###cur model: ",model.value,base_url)
...
async def stream_claude_response(
    ...
    start_time = time.time()
    # Use the provided base_url or default if None
    client = AsyncAnthropic(api_key=api_key, base_url=base_url or 'https://hk.uniapi.io/claude')
